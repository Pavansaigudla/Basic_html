...
function login(form) {
    ...
    if ((mailusername.value == "demouser@gmail.com") || (mailusername.value == "abc@gmail.com") || (mailusername.value == "admin@gmail.com")|| (mailusername.value == "pgudla@gmail.com")|| (mailusername.value == "gudla@gmail.com")) {
...
function paynow(){
    ...
    aptrinsic('track','transaction',{"status":Output, "AmountValue" :Amount.value});
